...
public class UserTestData {
    ...
    public static final User user1 = new User(USER_ID, "User1", USER_MAIL, "{noop}password", Role.USER);
    public static final User admin = new User(ADMIN_ID, "Admin", ADMIN_MAIL, "{noop}admin", Role.ADMIN, Role.USER);
    public static final User user2 = new User(START_SEQ + 2, "User2", "user2@yandex.ru", "{noop}password", Role.USER);
    public static final User user3 = new User(START_SEQ + 3, "User3", "user3@yandex.ru", "{noop}password", Role.USER);
    public static final User user4 = new User(START_SEQ + 4, "User4", "user4@yandex.ru", "{noop}password", Role.USER);
